...
local function ESPTick()
    ...
    if not crowded and HUD and currentPawn then
        ...
        HUD:AddDebugText("Modded By @ROCKYBHAI711", currentPawn, 1, {X=0,Y=0,Z=145}, {X=0,Y=0,Z=145}, {R=255,G=200,B=0,A=255}, true, false, true, nil, 1.0, true)
    end
end
